...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <h4 class="mb-0" style="font-family:'Space Grotesk',sans-serif;font-weight:700">{{ __('analytics.page_create_goal') }}</h4>
</div>
...
<div class="pa-card" style="max-width:600px">
    <form method="POST" action="{{ route('user.goals.store') }}">
        ...
        <div class="mb-3">
            ...
            <small style="color:var(--pa-text-muted);font-size:0.8125rem">{{ __('analytics.hint_target_path') }}</small>
        </div>
        <div class="mb-3">
