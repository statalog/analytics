...
class AiSourcesController extends Controller
{
    use HasDateRange;
    ...
    public function index(Request $request)
    {
        ...
        return view('user.ai-sources', [
            'site'        => $site,
            'breadcrumbs' => [['label' => 'AI Assistants']],
        ]);
    }
    ...
    public function data(Request $request)
    {
        ...
        foreach ($rows as $row) {
            ...
            if ($this->classifier->classify($domain, '') !== ChannelClassifierService::AI) continue;
