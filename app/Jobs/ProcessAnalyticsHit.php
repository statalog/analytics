...
class ProcessAnalyticsHit implements ShouldQueue
{
    ...
    public function handle(
        ...
        $analytics->insertPageview([
            ...
            'network_time'         => (int) ($this->payload['network_time'] ?? 0),
            'server_time'          => (int) ($this->payload['server_time'] ?? 0),
            'transfer_time'        => (int) ($this->payload['transfer_time'] ?? 0),
            'dom_processing_time'  => (int) ($this->payload['dom_processing_time'] ?? 0),
            'dom_completion_time'  => (int) ($this->payload['dom_completion_time'] ?? 0),
            'on_load_time'         => (int) ($this->payload['on_load_time'] ?? 0),
            'visit_duration'  => 0,
            'is_bounce'       => $isBounce,
